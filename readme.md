...
<img width="1760" height="897" alt="Image" src="https://github.com/user-attachments/assets/27cc8e78-49cb-4471-998f-c3b20580f60d" />

### Deployed link: https://cloudwithpooja.netlify.app/
...
- _If you're using the LinkedIn import, most of the data is already there._ [/src/constants/index.js](https://github.com/Pooja-Sree-K/cloud-with-poojasree/blob/main/src/constants/index.js) contains all the personal information one needs to change. Each website section is written as a JavaScript object and is pretty intuitive to change. 
...
- Icons
      ...
      - Import the icon into [`/src/constants/index.js`](https://github.com/Pooja-Sree-K/cloud-with-poojasree/blob/main/src/constants/index.js) (Eg: `import { ... SiReact, } from "react-icons/si";` here)

2. **Website title and icon**

    - Go to [`index.html`](https://github.com/Pooja-Sree-K/cloud-with-poojasree/blob/main/index.html) and change the [`title`](https://github.com/Pooja-Sree-K/cloud-with-poojasree/blob/main/index.html#L7") to your name.
    - Also, change the link to the title [icon](https://github.com/Pooja-Sree-K/cloud-with-poojasree/blob/main/index.html#L5)

3. **Assets**

    - Add any assets (images) to the [`assets`](https://github.com/Pooja-Sree-K/cloud-with-poojasree/tree/main/src/assets) folder.
    - Import the asset and export it using the[`/src/assets/index.js`](https://github.com/Pooja-Sree-K/cloud-with-poojasree/blob/main/src/assets/index.js) file.
...
- Please read and abide by our [Code of Conduct](https://github.com/Pooja-Sree-K/cloud-with-poojasree/blob/main/CODE_OF_CONDUCT.md);
our community aspires to be a respectful place both during online and in-person interactions.
- Please follow the [installation guide](https://github.com/Pooja-Sree-K/cloud-with-poojasree/blob/main/readme.md#installation-guide) and the [sample git workflow](https://github.com/Pooja-Sree-K/cloud-with-poojasree/blob/main/readme.md#sample-git-workflow) to contribute.
...
- Set the upstream remote to the original repository url so that git knows where to fetch updates from in future: `git remote add upstream https://github.com/Pooja-Sree-K/cloud-with-poojasree.git`
...
- Follow the [installation guide](https://github.com/Pooja-Sree-K/cloud-with-poojasree/blob/main/readme.md#installation-guide) to install the software
- Create a new feature branch with `git checkout -b <name-of-your-feature-branch>`
- Make changes and commit them in the feature branch.
- Once done developing, switch back to the main branch with `git checkout main` ; pull the latest version of the repo with `git pull https://github.com/Pooja-Sree-K/cloud-with-poojasree.git main`
